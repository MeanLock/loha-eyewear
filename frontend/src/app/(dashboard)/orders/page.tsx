    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground mt-2">Quản lý, thông duyệt và theo dõi các đơn đặt hàng.</p>
            </div>
            <div className="rounded-xl border bg-card text-card-foreground shadow-sm p-8 text-center flex flex-col items-center justify-center min-h-[300px]">
                <p className="text-muted-foreground font-medium">Danh sách đơn hàng sẽ hiển thị tại đây.</p>
            </div>
        </div>
    )
}
